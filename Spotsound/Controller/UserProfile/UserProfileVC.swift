...
class UserProfileVC: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    func fetchCurrentUserData(){
        ...
        Database.database().reference().child("users").child(currentUserUid).child("username").observeSingleEvent(of: .value) { (snapshot) in
    ...
    override func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        let header = collectionView.dequeueReusableSupplementaryView(ofKind: kind, withReuseIdentifier: userProfileHeaderCell, for: indexPath)
        return header
    }
